-- Skema Database Relasional Sistem Pelanggaran & Poin Santri Halaqah Al-Qur'an
...
CREATE TABLE IF NOT EXISTS students (
  id TEXT PRIMARY KEY,
  student_number TEXT UNIQUE NOT NULL, -- NIS
  name TEXT NOT NULL,
  class TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS violation_records (
  ...
  teacher_id TEXT,
  violation_id TEXT,
  -- Snapshot Data permanen saat kejadian
...
-- Master Kegiatan Baik / Hal Positif (Reward & Pengurangan Poin)
...
-- Catatan Riwayat Kebaikan & Pengurangan Poin Santri
